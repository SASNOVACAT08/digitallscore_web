    ...
    <div class="col-6">
      <div class="row">
        <div class="col">
          ...
          <h2 class="display-4 m-5">   <svg id="back" class="bi bi-arrow-left-circle-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="red" xmlns="http://www.w3.org/2000/svg" @click="back">
